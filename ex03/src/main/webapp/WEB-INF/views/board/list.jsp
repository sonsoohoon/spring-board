            ...
            <div class="row">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${list}" var="board">
                                	<tr>
                                		...
                                		<%-- <td><a href='${pageContext.request.contextPath}/board/get?bno=<c:out value="${board.bno}" />' target='_blank'>  --%>
         	...
         	$(document).ready(function() {
         		...
         		function checkModal(result) {
         			...
         			$("#myModal").modal("show"); 
         		} //function checkModal(result) end
         		...
         		$(".paginate_button a").on("click", function(e) {
         			...
         			actionForm.submit();
         		});/* $(".paginate_button a").on("click", function(e) { end */
